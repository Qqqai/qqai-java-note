...
public abstract class VFS {
  ...
  /**
   * Get the singleton {@link VFS} instance. If no {@link VFS} implementation can be found for the current environment, then this method returns
   * null.
   *
  ...
  /**
   * Adds the specified class to the list of {@link VFS} implementations. Classes added in this manner are tried in the order they are added and
   ...
   * @param forPath The path to the resource that is identified by the URL. Generally, this is the value passed to {@link #getResources(String)} to
